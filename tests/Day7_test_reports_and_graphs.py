...
from bank import (
    ...
    , ReportBuilder  # класс построения отчетов и отрисовки графики
)


def test_reports_and_graphs():
    ...
    audit_log = AuditLog('AuditLog_Day7')
    ...
    new_processor.add_transaction_in_queue('num9', 'ttt', None,
                                           'deposit', 1, 'USD', "etf", "2026-12-20", queue_priority=3)
    new_processor.add_transaction_in_queue('num10', 'ttt', None,
                                           'deposit_securities', 10, 'USD', "etf", "2026-12-20", queue_priority=4)
    new_processor.add_transaction_in_queue('num11', 'ttt', None,
                                           'withdraw_securities', 4, 'CNY', "etf", "2026-12-20", queue_priority=5)
    ...
    new_processor.add_transaction_in_queue('qwer10', 'sss', 'qqq',
                                           'deposit', 100, 'RUB', queue_timestamps="2027-01-27", queue_priority=5)
    new_processor.add_transaction_in_queue('qwer11', 'sss', 'www',
                                           'withdraw', 200, 'RUB', queue_timestamps="2027-02-27", queue_priority=5)
    new_processor.add_transaction_in_queue('qwer12', 'sss', 'ttt',
                                           'deposit', 150, 'RUB', queue_timestamps="2027-03-27", queue_priority=5)
    # Запуск очереди транзакций
    new_processor.apply_transaction()
    # Информация по работе транзакционного процессора (после запуска очереди)
    new_processor.__str__()
